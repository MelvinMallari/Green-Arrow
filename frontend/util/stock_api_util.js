...
export const fetchStock = symbol => $.ajax({
  method: 'GET',
  url: `api/stocks/${symbol}`,
});

export const fetchStocks = () => $.ajax({
  method: 'GET',
  url: 'api/stocks',
});

export const fetchStockData = symbol => $.ajax({
  method: 'GET',
...
export const fetchStockIntradayData = symbol => $.ajax({
  method: 'GET',
...
export const fetchStockInfo = symbol => $.ajax({
  method: 'GET',
  url: `https://cloud.iexapis.com/stable/stock/${symbol}/batch?types=stats,company&token=pk_a62a60b278194113b62e185687b44f91`,
  // url: `https://api.iextrading.com/1.0/stock/${symbol}/batch?types=stats,company`,
});

export const fetchStockNews = symbol => $.ajax({
  method: 'GET',
